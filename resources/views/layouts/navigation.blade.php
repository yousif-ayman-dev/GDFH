    ...
    <div class="space-y-1">
      ...
      <a href="{{ route($item['route']) }}"
        ...
        <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg" @if ($isActive)
          ...
          <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
            aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-.623 0-1.242-.014-1.859-.042A11.758 11.758 0 0110 17.25c-4.28 0-7.857-2.637-8.91-6.315a3.375 3.375 0 013.285-4.298h10.965c.575 0 1.127.18 1.59.511z" />
          </svg>
          @break
          @endswitch
        </span>
